...
-- 用户表
INSERT INTO ezd_users VALUES (DEFAULT,'15179791514','22d7c725d882735922786637d8f9b9a',DEFAULT),(DEFAULT,'13679791514','f60fca59e4481e6af5498007b4fd16e',DEFAULT),
(DEFAULT,'15979791514','48f97f49b35a662fbb0d6cde0afeda1',DEFAULT),(DEFAULT,'17679791514','d31515537c436f229a6a6f130eb3fddc',DEFAULT),(DEFAULT,'13680399658','0390f4a145c685cbe734ef97e1b51c20',DEFAULT),
...
-- 用户信息表
INSERT INTO ezd_umg VALUES (1,1,'logo.png','刘小峰','男','1996-08-26','1336629729@qq.com','南方','java','大专','菜的一波','广东南方科贸培训学院就读于南1学院',DEFAULT ,'广东省珠海市',null,null,0);
INSERT INTO ezd_umg VALUES (2,2,'logo.png','刘小花','男','1997-08-26','1534354542@qq.com','南方小','php','大学','精英','广东南方科贸培训学院就读于南方2学院',DEFAULT ,'广东省深圳市',null,null,0);
INSERT INTO ezd_umg VALUES (3,3,'logo.png','刘小帽','男','1998-08-26','5342543543@qq.com','南方中','ui','博士','牛逼','广东南方科贸培训学院就读于南方3学院',DEFAULT ,'广东省东莞市',null,null,1);
INSERT INTO ezd_umg VALUES (4,4,'logo.png','刘小永','男','1999-08-26','5435435466@qq.com','南方大','前端','硕士','boss','广东南方科贸培训学院就读于南方4学院',DEFAULT ,'广东省广州市',null,null,1);
...
--  学校信息表
insert into ezd_schmg VALUES (1,'www.1nf.com','logo.png','南方学院','珠海市白蕉镇','该校相当NB',2,DEFAULT );
insert into ezd_schmg VALUES (2,'www.2nf.com','logo.png','北方学院','珠海市蓝蕉镇','该校相当NB',1,DEFAULT );
insert into ezd_schmg VALUES (3,'www.3nf.com','logo.png','西方学院','珠海市黄蕉镇','该校相当NB',3,DEFAULT );
